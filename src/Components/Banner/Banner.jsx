  ...
  return (
    ...
    >
      <div className="text-section mx-auto md:ml-10 lg:mx-60 md:mt-8 lg:mt-14">
        <h1 className="md:text-3xl lg:text-5xl font-bold">Welcome to Trendy<span className="text-yellow-500 font-primaryFont font-extrabold underline underline-offset-4 decoration-wavy">Ware</span></h1>
