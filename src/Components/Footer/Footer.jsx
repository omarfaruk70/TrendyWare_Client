...
const Footer = () => {
  ...
  return (
    <footer className="font-primaryFont p-10 mb-0 bg-neutral text-neutral-content">
      ...
      <div className="h-10 w-10 md:h-16 md:w-16 rounded-full p-5 flex justify-center absolute right-20 -mt-8 bg-yellow-600 text-blue-300">
      ...
      <div className="mt-5 flex flex-col md:flex-row justify-around">
        <div>
          <h2>
            Copyright &copy; 2023 - {fullYear} || All right reserverd By{" "}
            <a
              className="text-yellow-400"
              href="https://www.linkedin.com/in/omarfaruk70"
            >
              Omar Faruk
            </a>
          </h2>
